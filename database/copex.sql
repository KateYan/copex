...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 15, 2014 at 03:22 AM
...
CREATE TABLE IF NOT EXISTS `order` (
  ...
  KEY `uid` (`uid`),
  KEY `cid` (`cid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2753544 ;
...
(2753541, 10185, 10004, '2014-12-14', 0, 1, 0),
...
CREATE TABLE IF NOT EXISTS `orderitem` (
  ...
  PRIMARY KEY (`oitemid`),
  KEY `oid` (`oid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=10150 ;
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  KEY `cid` (`cid`,`vipid`),
  KEY `vipid` (`vipid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=10227 ;
...
(10185, 10004, 10142, '6131231234', '208795b584c83f3bae579f721868d1cbd4884783362387f95f50e35f810a3f50', '::1', 1, '2014-12-14 23:31:36', '2014-12-10 15:38:21'),
