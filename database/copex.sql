...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 17, 2014 at 06:30 AM
...
CREATE TABLE IF NOT EXISTS `order` (
  ...
  KEY `uid` (`uid`),
  KEY `cid` (`cid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2753594 ;
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  KEY `cid` (`cid`,`vipid`),
  KEY `vipid` (`vipid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=10238 ;
...
(10185, 10003, 10142, '6131231234', '208795b584c83f3bae579f721868d1cbd4884783362387f95f50e35f810a3f50', '::1', 1, '2014-12-17 05:28:51', '2014-12-10 15:38:21'),
...
(10237, 10004, NULL, NULL, '897fd9c0f53fa1d2d4cedaf50ce5b4b8', '::1', 0, '2014-12-17 05:29:24', '2014-12-17 05:29:24');
