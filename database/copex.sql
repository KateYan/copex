...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 05, 2015 at 01:10 AM
...
(10037, 10001, 10005, 1, 16),
(10038, 10003, 10005, 0, 16),
(10039, 10002, 10005, 0, 16),
...
CREATE TABLE IF NOT EXISTS `order` (
  ...
  KEY `uid` (`uid`),
  KEY `cid` (`cid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2753667 ;
...
(2753665, 10185, 10001, '2015-01-04 19:08:19', '2015-01-05', 0, 1, 9.3, 80.85),
...
CREATE TABLE IF NOT EXISTS `orderitem` (
  ...
  PRIMARY KEY (`oitemid`),
  KEY `oid` (`oid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=10405 ;
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  KEY `cid` (`cid`,`vipid`),
  KEY `vipid` (`vipid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=10301 ;
...
(10185, 10001, 10142, '6131231234', '208795b584c83f3bae579f721868d1cbd4884783362387f95f50e35f810a3f50', '::1', 1, '2015-01-05 00:08:45', '2014-12-20 04:38:21'),
...
(10142, 9646, 'a152e841783914146e4bcd4f39100686', 69.15),
