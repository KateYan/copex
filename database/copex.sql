...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 02, 2015 at 11:28 PM
...
(10029, 10005, 10011, 1, 50),
(10032, 10003, 10011, 0, 50),
(10033, 10009, 10011, 0, 50),
(10034, 10006, 10012, 1, 50),
(10035, 10002, 10012, 0, 50),
(10036, 10007, 10012, 0, 50),
(10037, 10001, 10005, 1, 50),
(10038, 10003, 10005, 0, 50),
(10039, 10002, 10005, 0, 50),
(10040, 10004, 10006, 1, 50),
(10041, 10007, 10006, 0, 50),
(10042, 10008, 10006, 0, 50),
(10055, 10005, 10022, 1, 50),
(10056, 10002, 10022, 0, 0),
(10057, 10006, 10022, 0, 50);
...
CREATE TABLE IF NOT EXISTS `order` (
  ...
  KEY `uid` (`uid`),
  KEY `cid` (`cid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2753655 ;
...
(2753653, 10295, 10002, '2015-01-02 17:12:00', '2015-01-03', 0, 0, 1.3, 11.29),
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  KEY `cid` (`cid`,`vipid`),
  KEY `vipid` (`vipid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=10297 ;
...
(10185, 10002, 10142, '6131231234', '208795b584c83f3bae579f721868d1cbd4884783362387f95f50e35f810a3f50', '::1', 1, '2015-01-02 08:14:10', '2014-12-20 04:38:21'),
