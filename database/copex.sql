...
CREATE TABLE IF NOT EXISTS `order` (
  ...
  KEY `uid` (`uid`),
  KEY `cid` (`cid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2753593 ;
...
(10269, 2753591, 50003, 0),
(10270, 2753591, 50004, 0),
(10271, 2753592, 10005, 0),
(10272, 2753592, 10009, 0),
(10273, 2753592, 50003, 0);
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  KEY `cid` (`cid`,`vipid`),
  KEY `vipid` (`vipid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=10237 ;
...
(10185, 10003, 10142, '6131231234', '208795b584c83f3bae579f721868d1cbd4884783362387f95f50e35f810a3f50', '::1', 1, '2014-12-17 00:38:11', '2014-12-10 15:38:21'),
