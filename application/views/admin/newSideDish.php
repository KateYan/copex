                        ...
                        <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                            <div class="form-horizontal">
                                <fieldset>
                                    ...
                                    <?php
                                    $attributes_1 = array('id'=>'newSideDish');
                                    echo form_open('dishcontroller/newSideDish',$attributes_1);
                                    echo form_close();

                                    $attributes_2 = array('id'=>'upload_2');
                                    echo form_open_multipart('dishcontroller/upload_2',$attributes_2);
                                    echo form_close();
                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <div class="bootstrap-admin-panel-content">
                                                    <div class="row bootstrap-admin-light-padding-bottom">
                                                        <div class="col-md-4">
                                                            <a class="thumbnail">
                                                                ...
                                                                if(isset($_SESSION['upload'])){
                                                                    echo '<img data-src="holder.js/260x180" alt="260x180" style="width: 100%; height: 100%;" src="/copex/upload/side/';
                                                            ...
                                                            <?php
                                                            echo '<input form="newSideDish" type="hidden" name="dishPicture" value="';
                                                            if(isset($_SESSION['upload'])){
                                                                echo $_SESSION['upload'];
                                                            }
                                                            echo '"required />';
                                                        ...
                                                        <div class="col-lg-4">
                                                            <input form="upload_2" class="form-control" type="file" name="userfile" />
                                                            <!--                                                        </div>-->
                                                            <div style="margin-top: 10px;">
                                                                <span style="margin-top: 10px;">

                                                                    <input form="upload_2" type="submit" class="btn btn-sm btn-info" name="picture" value=" 确认上传"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input form="newSideDish" class="form-control" type="text" name="dishName" required />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="input-group">
                                                ...
                                                <input form="newSideDish" class="form-control" type="text" name="dishPrice" required />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            ...
                                            for($j = 0; $j<$num; $j++){
                                                ...
                                                echo '<input form="newSideDish" type="radio"';
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <textarea form="newSideDish" id="textarea-wysihtml5" name="dishDes" class="form-control textarea-wysihtml5" style="width: 100%; height: 200px"></textarea>
                                        </div>
                                    </div>
                                    <button form="newSideDish" type="submit" class="btn btn-primary">
