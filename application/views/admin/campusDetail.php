                                            ...
                                            <div class="panel panel-default">
                                                <div class="panel-heading">
                                                    <div class="text-muted bootstrap-admin-box-title">取餐地点如下
                                                        ...
                                                        <?php
                                                        if(isset($eMsg['delPlaceError'])){
                                                            echo '<span style="color: #be2221;float:right;"><b>'.$eMsg['delPlaceError'].'</b></span>';
                                                        } elseif(isset($eMsg['delPlaceSuccess'])){
                                                            echo '<span style="color: #be2221;float:right;"><b>'.$eMsg['delPlaceSuccess'].'</b></span>';
                                                        }
                                                        ?>
                                                    </div>
                                                </div>
                                                <div class="bootstrap-admin-panel-content">
                                                    <table class="table table-striped">
                                                        ...
                                                        for($i = 0;$i<$num; $i++){
                                                            echo '<tr>';
                                                            echo '<td>'.$_SESSION['campus']['placeID'][$i].'</td>';
                                                            echo '<td>'.$_SESSION['campus']['placeName'][$i].'</td>';
                                                            echo '<td>'.$_SESSION['campus']['placeAddr'][$i].'</td>';
                                                            echo '<td>'.'<input form="removePickupPlace" type="radio" name="place" value="'.$_SESSION['campus']['placeID'][$i].'"/></td>';
                                                            echo '</tr>';
                                                        }
                                                        ?>
                                                        </tbody>
