            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-header">
                        <h1>取餐地点--ID:
                            <?php
                            echo $_SESSION['pickupPlace']->placeID;
                    ...
                    <div class="panel panel-default bootstrap-admin-no-table-panel">
                        ...
                        <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                            <div class="form-horizontal">
                                ...
                                echo form_open('basiccontroller/editPlacePickupTime',$attributes);
                                echo form_close();
                                ?>
                                <fieldset>
                                    <legend>取餐地点名:
                                        <?php
                                        echo $_SESSION['pickupPlace']->placeName;
                                        ?>
                                    </legend>
                                    <input form="editTime" class="form-control" type="hidden" name="placeID" value="<?php echo $_SESSION['pickupPlace']->placeID; ?>"/>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label" for="focusedInput">取餐地址</label>
                                        <div class="col-lg-10">
                                            <input readonly class="form-control" type="text" value="<?php echo $_SESSION['pickupPlace']->placeAddr; ?>"/>
                                        </div>
                                    </div>
                                    <div class="form-group<?php if(isset($eMsg['pstartwrg'])){echo " has-error";}?>">
                                        <label class="col-lg-2 control-label">取餐开始时间</label>
                                        <div class="col-lg-10">
                                            <input form="editTime" class="form-control" type="text" name="pickup-start" value="<?php echo $_SESSION['pickupPlace']->userPickupStart; ?>"/>
                                    ...
                                    <div class="form-group<?php if(isset($eMsg['pendwrg'])){echo " has-error";}?>">
                                        ...
                                        <div class="col-lg-10">
                                            <input form="editTime" class="form-control" type="text" name="pickup-end" value="<?php echo $_SESSION['pickupPlace']->userPickupEnd; ?>"/>
                                            <span class="help-block">
                                                <?php
                                    ...
                                    <a type="reset" href="showPlacePickupTime/" class="btn btn-default">
