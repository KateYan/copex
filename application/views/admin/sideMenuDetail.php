                ...
                <div class="col-lg-12">
                    <div class="panel panel-default bootstrap-admin-no-table-panel">
                        <div class="panel-heading">
                            <?php
                            $attributes = array('id'=>'deleteSideMenu');
                            echo form_open('menucontroller/deleteSideMenu',$attributes);
                            echo form_close();
                            ?>
                            <div class="text-muted bootstrap-admin-box-title">菜单详情
                                <button form="deleteSideMenu" type="submit" class="btn btn-sm btn-danger" style="float: right;">
